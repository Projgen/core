import { TemplateError, type StepCondition } from "@/template-engine/domain";
...
const getStringVariableValue = (
  ...
  return {
    variable: variable as VariableValue & { content: string },
...
const getArrayVariableValue = (
  ...
  return {
    variable: variable as VariableValue & { content: unknown[] },
...
const getNumberVariableValue = (
  ...
  return {
    variable: variable as VariableValue & { content: number },
    condition: condition as StepCondition & { value: number },
  };
};

const getVariableValue = (variableName: string, variables: VariableValue[]) => {
